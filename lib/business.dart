...
class business extends StatelessWidget {
   ...
   Future getpost() async {
     var url = "https://newsapi.org/v2/top-headlines?country=eg&category=business&apiKey=ff07382cc1f84dc4870f8ed0d3def8b7";
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                           ...
                           String  url = snapshot.data['articles'][i]['url'];
